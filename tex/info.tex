% Informações gerais
%
\title{Identificação de controladores não lineares NARMAX utilizando referência virtual}
...
\examinerinfo{UFRGS}{Doutora em Engenharia Elétrica (PPGEE), UFRGS -- Porto Alegre, Brasil}
