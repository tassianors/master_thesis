...
%\renewcommand{\lstlistlistingname}{My listings} %List of listings name
\renewcommand{\lstlistingname}{Listagem} %Listings name
...
\hypersetup{
	...
	pdfsubject={Projeto de controladores não lineares usando referência virtual.},
	pdfkeywords={System identification, data-base control design, Virttual Reference, nonlinear systems},
