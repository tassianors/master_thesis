...
a modelagem do sistema é o objetivo principal da identificação, para tanto leva-se em conta apenas os parâmetros de
...
Ao integrar ao modelo do sistema, os parâmetros de $H(q, \theta)$, surge o inconvenientede que se o denominador de
