...
custo, chamada critério. Na seção \ref{sec:sys_ident_intro} foi apresentado o critério de minimização mais utilizado
...
\begin{itemize}
  ...
  muito alto. O que implica que $A(z)$ e $B(z)$ possuem fatores comuns. Podendo ocasionar dinâmicas no modelo que
