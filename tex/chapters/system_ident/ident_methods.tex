...
para determinação da órbita dos planetas \cite{system_identification}. Método este que veio a ser conhecido pelo nome de
...
ou erro de polarização. Nesta seção será apresentado uma breve discussão sobre um dos métodos que se propõe a sanar este
