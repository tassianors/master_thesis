...
\begin{itemize}
  ...
  muito alto, com relação a ordem do sistema o que implica que $A(z)$ e $B(z)$ possuem fatores comuns. 
...
\nonumber
\end{equation}
o sistema não é linearmente parametrizável quando todos os polinômios são diferentes do caso unitário ($A(z),\ldots,
