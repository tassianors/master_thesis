...
\end{equation}
onde $G_0(z)$ é a função de transferência que descreve o comportamento da planta
real, $H_0(z)$ é a função de transferência que atua sobre o ruído branco
...
parametrizada por um vetor $\theta \in \mathbb{R}^d$. Desta forma o sistema a ser identificado pode ser representado
como:
...
\end{equation}
onde as funções de transferência $G(z, \theta)$ e $H(z, \theta)$ podem ser
definidas como:
...
$H(z,\theta)$  sejam o mais próximo possível de $G_0(z)$ e $H_0(z)$. .O vetor $\theta$ que faz com que estas duas
...
\begin{equation}
\varepsilon (t,\theta)=e(t)=H^{-1}(z, \theta)\left \{ y(t)-G(z, \theta)u(t) \right \}
\nonumber
\end{equation}
