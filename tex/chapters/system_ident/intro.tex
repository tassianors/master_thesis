...
\end{equation}
onde $z$ é o operador de avanço de tempo $z*x(t)=x(t+1)$, $G_0(z)$ é a função de transferência que descreve o
comportamento da planta real, $H_0(z)$ é a função de transferência que atua sobre o ruído branco $e(t)$; $u(t)$ é o
sinal de entrada aplicado sobre a planta e $y(t)$ é o sinal de saída, ambos medidos e conhecidos.
...
\end{equation}
onde as funções de transferência $G(z, \theta)$ e $H(z, \theta)$ são funções racionais do operador $z$.
...
\begin{align}\nonumber
G(z, \theta_0) &= G_0(z) \\ \label{eq:si_intro_true_theta} 
H(z, \theta_0) &= H_0(z) 
\end{align}
