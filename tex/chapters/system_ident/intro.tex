...
outras palavras, qual modelo melhor consegue representar o sistema real $\mathcal{S}$ de acordo com o critério
escolhido.

Uaualmente o critério mais utilizado é o de erro de predição. 

Preditores são equações que predizem qual será o próximo valor de saída do sistema
baseado noconjunto do modelo e nos valores de dados coletados até aquele momento.
...
predição. Existe um processo que se deseja estimar, para isso escolhe-se uma classe de modelos onde os
