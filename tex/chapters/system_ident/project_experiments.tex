...
Uma forma de organizar o projeto de experimentos é desenvolve-lo como um problema de otimização 
...
Como foi apresentado na Seção \ref{sec:si_data_persistently_excitation} é
...
semelhantes a de ruído branco. Este sinal é gerado pela equação:
...
As vantagens e desvantagens do sinal PRBS comparado com um sinal binário randômico pode ser listado: \cite{ljung}
...
%===============================================================================
\subsection{Projeto de experimento visto como um problema de otimização}
