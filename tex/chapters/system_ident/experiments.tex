...
informativo se a ordem de excitação for  $n_b+n_a$. Em \cite{gevers_bazanella2009} foram apresentadas as condições
necessárias e suficientes para informatividade em estruturas de modelos arbitrárias.
