...
\begin{itemize}
  ...
  flexibilidade pode ser obtida usando-se vários parametros ou alocando-os em ``posições estratégicas''.
  \item Parsimonia: Não usar desnecessáriamente uma quantidade elevada de parametros.
