...
Devem ser levadas em consideração algumas premissas básicas sobre o sinal de excitação do sistema e sobre a escolha da
...
parâmetros da família de modelos possam ser identificados de forma satisfatória.
...
deste tipo. O que dificulta esta tarefa é o fato de nem sempre a ordem do sistema ser algo conhecido. É necessário
