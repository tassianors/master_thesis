...
Na Figura (\ref{fig:si_models_diagram_narmax}) é apresentado o diagrama de blocos para o modelo {\bf{ARMAX}}. Onde:
...
Quando usam-se apenas um conjunto dos polinômios de $A(z),\ldots, F(z)$ obtemos as estruturas de modelos
