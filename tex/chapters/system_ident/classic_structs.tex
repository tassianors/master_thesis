...
apresentados conjuntos de modelos para sistemas SISO discretos invariantes no tempo e algumas das famílias mais
...
combinação de $\theta$, um novo modelo é definido. Podendo desta forma serem definidos como:
...
Quando usa-se apenas um conjunto dos polinômios de $A(q) \;\cdot\; F(q)$ obtemos as estruturas de modelos
