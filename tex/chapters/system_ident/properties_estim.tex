...
então a estimativa do modelo $G_N(z)$.\cite{campestrini, solari}

\begin{equation}
\Delta Q_N(z) \equiv \hat{z}_N(z)-Q(z)
...
\begin{equation}
Q^*(z)=\left [ G(z, \theta^*) \;\;\; H(z, \theta^*)\right ]
\end{equation}
...
G_0(z) \in \mathcal{G}
\end{equation}
mas a função de transferência do filtro real do ruído $H_0(z)$ não consegue ser totalmente descrito pelo conjunto de
