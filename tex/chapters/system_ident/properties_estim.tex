...
as condições para evitá-las, ou reduzí-las.
...
que exista um atraso de tempo tanto em $G_0(z)$ quanto em $G(z,\theta)$. Então:
...
A qualidade da estimativa pode ser calculada em termos da diferença entre o processo real $Q_0(z)$ e o melhor sistema
...
G_0(z) \in \mathcal{G}
\end{equation}
mas a função de transferência do filtro real do ruído $H_0(z)$ não consegue ser totalmente descrita pela classe de
