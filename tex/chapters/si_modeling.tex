...
Com $G(q)$ sendo a representação da planta e $H(q)$ a descrição do ruido que afeta o sistema.
Ambos sendo representados como abaixo:
...
os coeficientes do denominador e numerador destes polinômios sejam os objetivos do processo de identificação.
