...
em \eqref{eq:si_modeling_lti} e que podem ser caracterizados pela utilização de vários polinômios, nada mais são do que famílias de modelos.
...
saída. Este é de certa forma um problema para a escolha do modelo que será utilizado, pois se ambos chegam
teoricamente à mesma resposta, qual dos modelos é o melhor? Este é um dos motivos pelos quais a correta
escolha de uma família de modelos, é importante.
