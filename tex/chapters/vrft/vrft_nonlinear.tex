...
A equação de $M(z)$ pode ser reescrita em função do tempo como em:
...
Ao igualarmos a equação \eqref{eq:vrft_nl_dinamic_ex1_y} com \eqref{eq:vrft_nl_dinamic_ex1_mt} e isolando o
sinal $u(t)$ temos a equação que descreve o comportamento do controlador que levará a planta a ter o
