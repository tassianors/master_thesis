...
Identificação de sistemas é baseada no conjunto de dados que se tem do sistema observado. Estes dados podem ser
coletados em regime normal de operação ou sob condições pré determinadas, onde é possível escolher previamente
...
Pelo que foi visto anteriormente (Seção \ref{sec:si_data_persistently_excitation}) é fácil caracterizar
experimentos que são suficientemente informativos.
