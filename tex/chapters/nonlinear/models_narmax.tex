...
Leontaritis e Billings rigorosamente provaram que um sistema não linear invariante no tempo de tempo discreto pode
ser sempre representado por um modelo do tipo \cite{chen_billings1989}:
...
onde $e(t)$ é o ruído e $n_e$ é o maior atraso no modelo do ruído. O modelo apresentado
...
\begin{equation}
y(t)=\frac{a(\Upsilon)}{b(\Upsilon)}+e(t)
...
são polinômios e assumindo que o modelo é formado pela razão de dois polinômios, é conveniente definir o numerador e
denominador de \eqref{eq:nl_model_narmax_rat_simp} como em:
