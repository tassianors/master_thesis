...
\end{equation}
onde $\Phi_{nl}(\cdot)$ denota um campo vetorial não linear de dominio $\mathbb{R}^3\to \mathbb{R}^n$, que depende dos
sinais passados de $y(t)$ e presente e passados de $u(t)$ e $e(t)$. $\theta$ é o vetor de parâmetros a ser identificado.
