...
Por fim será apresentado um exemplo real de um conversor de corrente continua para corrente continua do tipo Buck. Será
utilizado um conjunto de modelos $\mathcal{M}$ para representar este sistema.

Serão apresentados os resultados obtidos afim de verificar a qualidade dos resultados obtidos e a confiabilidade do
...
\begin{equation}
\text{variância }\;\theta =1.0\times 10^{-3} \begin{bmatrix}
