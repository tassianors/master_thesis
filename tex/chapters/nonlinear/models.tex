...
afinidade em representar certos tipos de não linearidades. Entende-se por afinidade a característica de conseguir
representar o sistema com um número de parâmetros menor que outro modelo com outra base e que use mais parâmetros para
...
Na Figura \ref{fig:nl_models_hammerstein_wiener} observa-se o diagrama de blocos para os modelos de Hammerstein e
Wiener.
