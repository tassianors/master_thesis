...
\end{equation}
onde $h_j$ são generalizações não lineares da resposta ao impulso $h_1(t)$ . Para um sistema linear com $j=1$ a equação
...
neurônio com $n$ entradas é apresentada na equação:
...
\usefont{T1}{ppl}{m}{n}
\rput(5.153437,-2.61){$z^{-1}$}
\usefont{T1}{ppl}{m}{n}
\rput(5.153437,-4.79){$z^{-1}$}
