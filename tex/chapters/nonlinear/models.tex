...
Para estes sistemas a forma mais usual de caracterizar é utilizando a classe de modelos de Wiener para não linearidades
na saída do processo ou a classe de Hammerstein, quando a não linearidade está na entrada do processo.
...
e/ou a saída. Este será o caso de atuadores não lineares com características como saturação, zona morta, entre outros.
...
sistema e isso inevitavelmente significa que que um conjunto excessivo de parâmetros é necessário para descrever até mesmo
simples sistemas não lineares e consequentemente apenas poucas aplicações práticas foram apresentadas.
...
Sendo $b$ (bias) e $\omega_j$ constantes. $\emph{f}(\cdot)$ é chamada função de ativação. A
