...
descrever até mesmo simples sistemas não lineares e consequentemente apenas poucas aplicações práticas foram
apresentadas \cite{chen_billings1989}.
...
$\omega_j$ e $b$ são os parâmetros a serem identificados. A função de ativação mais comum é \cite{aguirre}:
...
\label{sec:nl_models_neurals_rec}
%===============================================================================
...
Os modelos racionais tratados em seguida são diferenciados dos demais apresentados neste trabalho, pois são foco de
