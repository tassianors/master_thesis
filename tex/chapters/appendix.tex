...
de entrada e saída da planta são alguns dos parâmetros para a estimativa, além de parâmetros de configuração do
...
%===============================================================================
\chapter{Rotinas para identificação classes de modelos Racionais}
...
identificação de um sistema conversor de corrente contínua extraído de \cite{tse_buck}.
...
\lstinputlisting[language=Matlab,
				...
				caption={Rotina utilizada para a identificação de um sistema racional}]
...
%===============================================================================
\section{Identificação de um controlador polinomial para um planta do tipo Wiener}
...
\ref{sec:dbnarmax_wiener_hammerstein_exemple}, onde o processo é do tipo Wiener e o controlador é do tipo polinomial.

\lstinputlisting[language=Matlab,
				frame=box,
				label=lst:vr_narmax_wiener,
				caption={Rotina para identificação de um controlador utilizando referência virtual em conjunto com o algoritmo para
...
%===============================================================================
\section{Identificação de um controlador racional para uma planta também racional}
...
\ref{sec:dbnarmax_rational_controllers}, onde o processo e o controlador são do tipo racional.

\lstinputlisting[language=Matlab,
				frame=box,
				label=lst:vr_narmax_simple,
				caption={Rotina para identificação de um controlador racional quando a planta do sistema é também um modelo
