...
Identificação de sistemas possui uma vasta aplicabilidade em inumeros ramos do conhecimento,
não é escopo deste trabalho enumerar todas as possibilidades de utilização desta ferramenta, nem tão pouco 
esmiuçar sua teoria. Será aqui abordado as principais caracteristicas e principios que compõem a teoria de 
...
descrever o sistema real sob observação, nas caracteristicas desejadas escolhidas.
