...
A estimativa dos parâmetros de modelos dependem de vários fatores, até agora foi apresentado
...
Não é apenas o tamanho (quantidade de pontos) do experimento que irá influenciar na qualidade da estimativa.
...
também influenciará na qualidade da estimativa, como pode ser visto no 
...
Como $P$ é a medida do tamanho do erro nos parametros, o Lemma \ref{lemma:si_par_estim_covariance} mostra
como este erro é relacionado com o espectro $\Phi_{\chi 0}$. O espectro cruzado $\Phi_{ue}$ é zero quando 
o sistema esta operando em laço aberto. \cite{jasson}
