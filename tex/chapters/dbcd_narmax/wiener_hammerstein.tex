...
O controlador $C_d'(z)$ possui um integrador em sua estrutura. Para evitar problemas de seguimento de
...
$T_d(z)$ quando submetido a um degrau unitário e o sinal do sistema real quando o controlador identificado com
