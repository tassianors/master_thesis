...
sendo $\zeta(t)$ e $\gamma(t)$ os blocos não lineares da planta e do controlador respectivamente. Analogamente $G'(z)$
e $C'(z)$ são os blocos lineares da planta e do controlador. Como a não linearidade do controlador está na entrada,
