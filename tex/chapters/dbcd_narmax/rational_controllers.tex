...
Esta aproximação será melhor quando mais este controlador for representavel em séries de Taylor, pois desta forma o
polinômio converge monotônicamente, fazendo com que os coeficientes de ordem maior, possam ser descartados devido a
contribuição destes termos decair monoticamente.
