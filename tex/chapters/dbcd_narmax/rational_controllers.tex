...
Serão apresentados exemplos onde a classe de controladores escolhida consegue representar o controlador ideal
$\mathcal{C}_d$ e quando isso não é possível.
...
No exemplo apresentado na Seção \ref{sec:dbnarmax_nl_dinamic_c_match} foi apresentada a simulação para o caso em que o
controlador ótimo consegue ser descrito pelo modelo escolhido para representa-lo. Neste exemplo ocorre o oposto: a
classe de modelos escolhida para o controlador não consegue representar completamente \eqref{eq:vrft_nl_dinamic_ex3_cd},
pois escolheu-se a seguinte classe de modelos:
