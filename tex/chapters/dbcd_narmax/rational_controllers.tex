...
Um modelo racional é descrito pela razão entre dois polinomios como:
...
Na Seção \ref{sec:nl_si_algorithms_rationals_examples} foram apresentados alguns resultados da utilziação do algoritmo
...
reduzido a zero, se a planta possuisse um integrador em sua estrutura, ou se, fosse adicionado um integrador ao
controlador e esta parcela da estrutura não fosse identificada em conjnto com o restante do controlador, evitando assim
