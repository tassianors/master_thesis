...
não linear $\mathcal{C}(\theta)$  quando operando em conjunto com o sistema não linear $\mathcal{S}$ resulta um sistema
em malha fechada cuja função de transferência é dada por $T_d(z)$. Opta-se que este comportamento em malha fechada seja
...
Como foi apresentado, a classe de modelos NARMAX pode ser dividida em polinomial:
