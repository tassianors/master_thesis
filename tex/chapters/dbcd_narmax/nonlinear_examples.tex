...
modelos NARMAX racionais ou polinomiais. Os sinais de enrtada do algoritmo de identificação serão obtidos por meio de
referência virtual.

Os exemplos se dividem de acordo com o típo de não linearidade. Na Seção \ref{sec:dbnarmax_nl_wiener} é apresentado um
