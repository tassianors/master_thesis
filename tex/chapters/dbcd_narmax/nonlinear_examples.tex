...
\begin{figure}[htbp] 
	...
	\caption{Erro entre o a resposta esperada e a obtida para o sismtema quando submetido a uma entrada do tipo degrau
	unitário.}
...
Obte-se um custo para o comportamento do sistema em malha fechada de  $J_{y}=1.0999$. Na Figura
...
\begin{figure}[htbp] 
	...
	$T(t)$ é o comporamento temporal para o sistema quando está utilizando o controlador identificado.}
