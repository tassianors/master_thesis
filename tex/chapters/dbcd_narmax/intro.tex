...
O método proposto neste trabalho consiste na idéia de utilizar referência virtual para, a partir dos dados coletados do
...
\usefont{T1}{ptm}{m}{n}
\rput(2.771875,1.2707813){\small $\varepsilon (t)$}
\usefont{T1}{ptm}{m}{n}
...
\caption{Representação em blocos do sistema em malha fechada para obtenção dos sinais $\varepsilon(t)$ e $\bar{r}(t)$
...
modelos NARMAX conseguem representar. Todavia, a idéia aqui apresentada, poderia ser aplicada para qualquer classe de
...
possuindo assim algum resquicio de comportamento não linear devido a planta $G_0(z)$. A influência do ruído sobre a
