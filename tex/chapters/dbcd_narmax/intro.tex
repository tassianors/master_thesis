...
Demais propriedades estatisticas e de convergência que foram apresentadas na Seção \ref{sec:sys_ident_prop_estim} podem
...
será também não linear, devido ao relacionamento apresentado em \eqref{eq:dbnarmax_perf_tracking_cd}. Supoem-se ainda
...
A classe de modeos NARMAX é subdividida em dois grupos principais: polinomial
...
O algoritmo proposto na Seção \ref{sec:nl_si_algorithms_rationals} pode ser aplicado para a identificação do dontrolar
que sobre as cirtunstâncias apresentadas será NARMAX.
