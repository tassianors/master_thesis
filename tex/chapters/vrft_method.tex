...
parametros $\rho_1$ e $\rho_2$ o resultado de 100 simulações com 1270 pontos
cada é apresentado na Figura (\ref{fig:vrft_bj_M10_var005}). O sinal de entrada
utilizado para a simulação foi PRBS (Seção
(\ref{sec:si_project_signal_input_prbs})).

\begin{figure}[htbp]
	\center
	\includegraphics[width=0.95\columnwidth]{figures/vrft_bj_M10_var005_.eps}
...
os mesmos. Isso se deve ao fato de que os dados são afetados por ruido e que
neste caso o método VRFT utilizando minimos quadrados irá estimar os valores com
algum erro de polarização.

% poderia colocar aqui o mesmo sistema mas utilizando IV.
