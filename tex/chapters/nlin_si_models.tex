...
a polarização da estimativa dos parâmetros adiciona-se termos do ruido no modelo.
Quando isso é feito o modelo passa a ser chamado de um modelo {\it{NARMAX}} (do
termo inglês {\it{nonlinear autoregressive moving average model with exogenous
variables}}) que pode ser representado pela equação \eqref{eq:nl_model_narmax} 
