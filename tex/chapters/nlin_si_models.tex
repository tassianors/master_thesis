...
refere-se ao fato do parâmetro poder ou não ser determinado nos valores medidos de entrada e saída
...
lineares, devido entre outros fatores, aos algoritmos desenvolvidos e a quantidade de sistemas
reais que podem ser descritos por estes modelos.
...
Uma das primeiras justificativas para o desenvolvimento de métodos para a escolha de modelos é a
grande dificuldade de trabalhar com modelos muito grandes e complexos. Existe o problema destes modelos
serem numericamente mal condicionados. Existe também uma convicção de que estes modelos, com muitos
parâmetros, são redundantes e poderiam ser removidos do modelo. Um modelo com um número excessivo de
parâmetros podem exibir dinâmicas que não são observadas no sistema real, desta forma não existe
