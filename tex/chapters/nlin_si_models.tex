...
Na seção (\ref{sec:sys_ident_modelling_choosing}) foi apresentado o conceito de conjunto de modelos para
...
linear enquanto que a parte naõ linear está concentrado ou na entrada ou na saída do sistema estaticamente.
Para estes sistemas a forma mais usual para caracterizar é utilizando o método de Wiener para não lineridades
na saída do sistem ou o modelo de Hammerstein, quando a não linearidade está na entrada do processo.
...
termos a ser identificada e com isso ter uma boa aproximação do sistema real com a menor quantidade de
parametros possível.

Percebe-se então que um mesmo sistema pode ser representado por diversos destes modelos, mas dependendo das
caracteristicas deste sistema, uma das famílias de modelos será mais adequada, por sua baser possuir mais
...
grandes. Existe o problema destes modelos serem numericamente mal condicionadosalém da convicção de que estes
...
Grande dificuldade de utilizar a serie de Voltera \eqref{eq:nl_models_volterra} é que
...
(Wienner, Hammerstein e Voltera). A necessidade do uso de entradas espaciais são também uma
...
dois polinômios, é conveniente definir o numerador e denominador de \eqref{eq:nl_model_narmax_rat}
...
%===============================================================================
\subsubsection{Estimador usando métodos dos mínimos quadrados}
