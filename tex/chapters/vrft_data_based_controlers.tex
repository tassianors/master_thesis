...
\end{itemize}
Onde $m_s(t)$ é o valor médio do sinal $s(t)$ e $R_s(t,r)$ é a covariancia do sinal $s$ nos
instantes $t$ e $r$.
\end{defn}
...
$H_0(z)$ saitisfaz $h(0)=1$. \cite{campestrini}
...
A equação \eqref{eq:vrft_db_closed_loop} descreve o comportamento do sistem da Figura
...
Controle baseado em dados pode ser dividido em dois grupos principais: metodos iterativos onde
experimentos são realizados sobre o sistema atualizand-se o controlador, o processo então é repetido
até que se atinja um valor minimo para a função custo deste sistema. O segundo grupo é o de metodos
não iterativos, onde apenas com um experimento, ou um conjunto de dados, os parametros do
