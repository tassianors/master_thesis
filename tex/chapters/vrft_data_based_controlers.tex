...
Em muitas aplicações praticas de controle, uma descrição matematica da planta não é disponível e o
...
(1942) com ajuste de controladores PID industriais. Depois do trabalho de Ziegler e Nichols
divesos trabalhos surgiram, muitos em formas de aperfeiçoamento e extensões das tecnicas ja
apresentadas, e algumas com desenvolvimentos em novas direções (\cite{mcmillan1983tuning},
...
caracteristicas, pois só requer que um experimento seja executado sobre a planta. 
\cite{campi_leccini_savaresi2002}

O projeto de controladores baseados em dados consiste obter ou estimar os parâmetros de um modelo
...
\caption{Sistema de controle em malha fechada, com presença do sinal de ruido.}
...
Para cada iteração $i$ em \eqref{eq:vrft_db_ift_algoritm}, o metodo IFT necessita de dois
