...
Como já foi apresentado no capítulo sobre identificação de sistemas lineares (capitulo
...
Outro objetivo fundamental é minimizar o efeito do ruído sobre a saída do sistema. Descreve-se a equação sensibilidade
$S(z, \theta)$ como:
...
$J_e(\theta)$ é o critério para minimização do ruído sobre a saída, é simples compreender que $J_y(\theta)$ integra  
...
O controladore apresentado em \eqref{eq:dbcd_perf_ce} também é conhecido naliteratura como controlador da minima
variância.
