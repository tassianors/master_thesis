...
critério $H_2$ em algo quadrático nos parâmetros. A função custo quadrática resultante pode ser minimizado
...
fundo em \cite{Hjalmarsson_ift1998, Hjalmarsson2002} e estendido em \cite{Prochazka2005} para critério de performances mais
gerais, que contém melhorias em objetivos de robustez \cite{Bazanella_h2criteria2008}.  
...
Para o objetivo de seguimento de referência, a performance pode ser avaliada pela norma \cite{bazanella_datadriven}:
...
performance de seguimento de referência, para o critério de rejeição ao ruido o controlador ótimo pode ser obtido. Para
