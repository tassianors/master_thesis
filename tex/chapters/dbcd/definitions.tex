...
Análogamente ao que foi apresentado para identificação de sistemas no Capítulo \ref{chapter:system_identification}, a
...
Existem vários critérios que podem ser utilizados para elecar qual será o melhor conjunto $\theta$ do controlador.
