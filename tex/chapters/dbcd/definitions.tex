...
função baseado no erro entre os dados observados do sistema real e a saída do modelo. (equação
\eqref{eq:si_obj_etim_lsm_v}). Para projeto de controladores existem desdobramentos deste critério em função dos
objetivos básicos de controle:
