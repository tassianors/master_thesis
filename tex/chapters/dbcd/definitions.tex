...
processo e não têm a intenção de determinar livremente a função de transferência do modelo. Ao invéz disso usa-se
...
tratato (a não ser que um controlador com dois níveis de liberdade seja usado \cite{lecchini_campi_savaresi_2dof}) e o mínimo
