...
Estes métodos são conhecidos como projetos de controladores baseados em dados ou do inglês {\it{data-driven }} ou
...
industriais, onde a parada do processo, para levantamento de informações, é muitas vezes indesejável e as vezes até
...
\ref{chapter:system_identification}), existe um critério para elencar qual é o melhor conjunto de parâmetros $\theta$
