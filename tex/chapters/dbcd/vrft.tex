...
Os parametros $\theta_0$ deste sistema é definido por $[ 0.4 \; -0.68 \; 0.288 ]$.

Como já foi observado a utilização de variáveis instrumentais melhora significativamente o erro de polarização existente
nas estimativas do método VRFT quando há presença de ruído. Desta forma as informações apresentadas a seguir serão
...
Considere o sistema real descrito por:
